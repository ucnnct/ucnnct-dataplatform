...
Transformations appliquées :
  ...
  clean_html_text  : clean_text + balises HTML + entités HTML    (RSS, StackOverflow, HackerNews)
...
def clean_text(col):
    """Nettoyage de base : octets nuls, caractères de contrôle, trim, espaces multiples."""
    return F.trim(
        F.regexp_replace(
...
def clean_html_text(col):
    """Nettoyage HTML : balises + entités + nettoyage de base. Pour RSS, StackOverflow, HackerNews."""
